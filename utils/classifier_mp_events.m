function [indic_opp,indic_att, indic_hom] = classifier_mp_events(mps)
    ...
    %
    % INPUTS:
    %   - mps       : table containing Target and Path factors from GSS
    %
    % OUTPUTS:
    %   - indic_opp : dummy variable indicating whether path and factors have
    %                opposite signs
    %   - indic_att : dummy variable indicating whether target is larger 
    %                 than path when both have opposite sign (attennuation)
    %   - indic_hom : dummy variable indicating whether path is larger 
    %                 than target when both have opposite sign (hom)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
